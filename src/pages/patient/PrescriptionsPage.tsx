    ...
    <div className="space-y-8">
      <section>
        ...
        <p className="mt-3 text-eu-blue/65">
          Consulta las prescripciones asociadas a tu atención médica.
        </p>
      </section>
      ...
      {prescriptions.length === 0 ? (
        <EmptyState
          icon={Pill}
          title="No tienes prescripciones activas"
          description="Cuando un profesional emita una prescripción disponible para tu cuenta, aparecerá en esta sección."
        />
      ) : (
              ...
              <div className="flex flex-col gap-6 sm:flex-row sm:items-start">
                ...
                <div className="flex-1">
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    <span className="rounded-full bg-eu-aqua-light px-3 py-1 text-xs font-semibold">
                      {prescription.status}
                    </span>
                  </div>
                  ...
                  <div className="mt-6 grid gap-4 text-sm sm:grid-cols-2">
                    <div className="flex gap-3 rounded-2xl bg-eu-grey p-4">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-eu-blue/55">
                          {prescription.issuedAt} — {prescription.expiresAt}
                        </p>
                      </div>
                    </div>
