    ...
    <div className="space-y-8">
      <section>
        ...
        <p className="mt-3 max-w-2xl text-eu-blue/65">
          Aquí puedes consultar tus próximas citas, documentos, prescripciones y
          opciones de soporte.
        </p>
      </section>
      ...
      <section aria-label="Próxima consulta">
        {nextAppointment ? (
          ...
          <EmptyState
            icon={CalendarDays}
            title="No tienes próximas consultas"
            description="Cuando tengas una nueva cita programada, aparecerá aquí con la fecha, hora y acceso a la teleconsulta."
          />
        )}
      </section>
      ...
      <section className="grid gap-5 md:grid-cols-3" aria-label="Accesos rápidos">
        <Link
          ...
          className="group rounded-3xl border border-eu-blue-light bg-white p-6 transition hover:-translate-y-1 hover:shadow-lg"
        >
